...
<div class="flex flex-grow items-center justify-center mt-5">

  <form on:submit|preventDefault={handleSubmit} class="flex w-1/2 relative text-gray-600 focus-within:text-gray-400">

    <span class="absolute inset-y-0 left-0 flex items-center pl-2 has-tooltip">
      ...
      <span class="flex flex-wrap text-left tooltip p-3 mt-1 lg:-mt-8 rounded-lg"
