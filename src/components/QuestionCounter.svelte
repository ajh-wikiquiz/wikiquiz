...
<div class="flex flex-row">
  ...
  <span class="has-tooltip">
    ...
    <span class="text-left tooltip p-3 mt-1 lg:-mt-8 rounded-lg"
      ...
      <span class="inline-block md:hidden">Currently: {$numQuestionsToGenerate}</span>
      Warning: The time to generate the quiz may increase dramatically. ):
    </span>
  </span>

  <span class="pr-5 hidden md:inline-block">
    Max # of questions to generate: {$numQuestionsToGenerate}
  </span>
